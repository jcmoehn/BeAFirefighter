  ...
  <div>
    ...
    <div class="full height p-4" v-if="fahrzeugtypen != ''">
      ...
      <div class="p-4 p-md-5">
        ...
        <TheCarNavigation :fahrzeugname="fahrzeugname"/>
      </div>
    </div>
    <!-- Fehlermeldung -->
...
<!-------- JAVASCRIPT -------->
<script>
import TheCarNavigation from '@/components/car/TheCarNavigation.vue'
import TheHeaderCar from '@/components/car/TheHeaderCar.vue'
export default {
