  ...
  <!-- Bild mit Text -->
    <div class="startHeader full height p-4">
      <div class="m-5 p-5"></div>
        ...
        <div>
          <h1 class="text-white display-1" style="font-family: Times, serif">Quiz</h1> 
          <div class="m-2 p-2"></div>
          <vue-typed-js :strings="['An diesen Fahrzeugen kannst du dein<br>Wissen auf die Probe stellen.<br>Schaue dir die einzelnen Quizze an<br>und teste dein Können.']" :showCursor="false" :startDelay="450" :typeSpeed="15">
