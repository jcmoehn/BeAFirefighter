...
<template>
  <div>
    <b-card>
      <b-card-header>
        <b-row>
        <b-col><h4>Infos über die linke Seite deines Autos</h4></b-col>
      ...
      <b-card>
        ...
        <!-- Editor zum Hochladen des Bildes der linken Außenseite -->
        <b-form-group
...
<script>
  ...
  export default {
      ...
      methods: {
        ...
        getZoomImage(image) {
          this.links.zoomImg.push(image)
        },
        saveAll() {
          this.links.werkzeuge = this.tool;
          this.links.sonderwerkzeuge = this.extraTool;
          console.log("TheLeftForm.saveAll(): " + this.links);
