...
<template>
  <!-- Bild mit Text -->
  <div class="startHeader full height p-4">
    <div class="m-5 p-5"></div>
    <div class="m-4 p-4"></div>
    <div>
      <h1 class="text-white display-1" style="font-family: Times, serif">Editor</h1> 
      <div class="m-2 p-2"></div>
      <vue-typed-js :strings="['In diesem Editor kannst du deine<br>eigenen Fahrzeuge speichern.<br>Hier kannst du individuell<br>deine Beladung anpassen.']" :showCursor="false" :startDelay="450" :typeSpeed="15">
        <h2 class="text-white display-5" style="font-family: Times, serif"><span class="typing"></span></h2>
      </vue-typed-js>     
    </div>
    <div class="m-5 p-5"></div>
    ...
    <div class="text-center" v-if="buttonsichtbar">
      ...
      <button class="scrollButton">
        <img src="@/assets/scrollDown.png" width="50%" v-scroll-to="'#scrolling'">
      </button>   
    </div>
...
<!-------- JAVASCRIPT -------->
<script>
  export default { // Datenobjekte die in der gesamten Komponente erreichbar sind
    data() {
      return {
...
<!-------- CSS -------->
<style scoped>
  .startHeader { /* Das Parallax richtig anzeigen */
    background: url('../../assets/editor.jpg') no-repeat center center;
